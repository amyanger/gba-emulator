...
/*
 * Embedded 8x8 bitmap font for X-Ray Mode.
 * Covers printable ASCII 0x20 (space) through 0x7E (~) = 95 glyphs.
 * Each glyph is 8 bytes: one byte per row, MSB = leftmost pixel.
 * Based on the classic IBM PC BIOS font (public domain).
 */
static const uint8_t xray_font_data[95][8] = {
    ...
    /* 0x74 't' */ {0x30, 0x30, 0x7C, 0x30, 0x30, 0x34, 0x18, 0x00},
